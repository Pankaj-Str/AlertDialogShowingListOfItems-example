...
public class MainActivity extends AppCompatActivity {
    ...
    public void withItems(View view) {
        ...
        builder.setPositiveButtonIcon(getResources().getDrawable(android.R.drawable.btn_dialog, getTheme()));
        builder.setIcon(getResources().getDrawable(R.drawable.ic_cake_black_24dp, getTheme()));
